 ...
 */
public class ProductTypeMOptionsDAO {

	private static final Log log = LogFactory.getLog(ProductTypeMOptionsDAO.class);
	...
	public ProductTypeMOptions merge(ProductTypeMOptions detachedInstance) {
		...
		try {
			ProductTypeMOptions result = (ProductTypeMOptions) sessionFactory.getCurrentSession()
	...
	public ProductTypeMOptions findById(int id) {
		...
		try {
			ProductTypeMOptions instance = (ProductTypeMOptions) sessionFactory.getCurrentSession()
	...
	public List<ProductTypeMOptions> findByExample(ProductTypeMOptions instance) {
		...
		try {
			List<ProductTypeMOptions> results = (List<ProductTypeMOptions>) sessionFactory.getCurrentSession()
