...
import br.com.uaibusiness.ecommerce.model.Products;

import static org.hibernate.criterion.Example.create;

/**
 * Home object for domain model class Products.
 * @see br.com.uaibusiness.ecommerce.model.Products
 * @author Hibernate Tools
 */
public class ProductsImplDAO extends GenericHibernateDAO<Products, Integer>
		implements ProductsDAO {

	private static final Log log = LogFactory.getLog(ProductsImplDAO.class);
	...
	public Products findById(int id) {
		...
		try {
			Products instance = (Products) getSession()
					.get("br.com.uaibusiness.ecommerce.model.Products", id);
			if (instance == null) {
	...
	public List<Products> findByExample(Products instance) {
		...
		try {
			List<Products> results = (List<Products>) getSession()
					.createCriteria("br.com.uaibusiness.ecommerce.model.Products").add(create(instance)).list();
