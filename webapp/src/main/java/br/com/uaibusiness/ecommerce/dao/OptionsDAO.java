...
public class OptionsDAO {
	...
	private static final Log log = LogFactory.getLog(OptionsDAO.class);
	...
	public Options merge(Options detachedInstance) {
		...
		try {
			Options result = (Options) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Options findById(int id) {
		...
		try {
			Options instance = (Options) sessionFactory.getCurrentSession()
	...
	public List<Options> findByExample(Options instance) {
		...
		try {
			List<Options> results = (List<Options>) sessionFactory.getCurrentSession()
